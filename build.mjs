...
const ASSETS = [
  ...
  { src: "33.png", out: "mockup-business-cards.jpg", mode: "jpeg",
    description: "Mockup: two evisions business cards on concrete blocks; one shows a sample contact (name, role, email).",
    tags: ["mockup", "stationery", "businesscard", "pattern"], orientation: "landscape", people: false, usage: "review",
    note: "Card shows a real name + work email. Personal data visible; confirm OK for public use." },
